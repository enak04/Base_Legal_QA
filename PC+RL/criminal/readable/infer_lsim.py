"""
infer_lsim_v3.py — Improved inference for LSIM
...
def load_kg(kg_path):
    # Load KG from fact_rule_chains.py (facts + rules as nodes, edges as tuples)
    ...
    G = nx.DiGraph()
    for n in list(frc.facts) + list(frc.rules):
        G.add_node(n)
